...
## THE PLAYER'S PAGE ARC (planned 2026-09-25)
...
`page.py`), 2 (the fights kept, `publish.py`, the page record, the
`page.py moves` check), 3 (the Angular page under `web/`: store,
Story, Answer, Chronicle, Party, Fight, Fights, the first e2e) and 4 (the
pause picker, Map, Quests, Record, level-up, option chips, unread marks,
the full e2e) are built -- designlog 2026-09-25. What is left:

- **Session 5** -- the play protocol in dm.md, the docs, a dress
  rehearsal.
