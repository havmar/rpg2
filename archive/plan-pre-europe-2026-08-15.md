# Archived roadmap before the Europe-map reset (2026-08-15)

> **HISTORICAL SNAPSHOT — NOT THE ACTIVE ROADMAP.** This is the complete
> former `plan.md`, moved intact when the fixed Europe-map rework became the
> sole active build. Its unfinished features and parked ideas were not
> rejected or shipped; they are simply unscheduled. Nothing in this file is
> implementation authority unless a future design session deliberately moves
> it back into `plan.md`. The active roadmap and build contract is `plan.md`.
