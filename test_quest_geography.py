...
class TheRumorRadius(unittest.TestCase):
    """Seed 536 opens at Bramwell, with Dublin two days off carrying
    ...
    2026-09-12 from seed 222 -- the gate cities' census moved the start
    draw; 2026-08-22 from seed 21, and before that from seed 19.)"""

    def setUp(self) -> None:
        self.world = _world(536)
    ...
    def test_the_single_day_group_says_day_not_days(self) -> None:
        world = _world(18)      # Magdeburg, with Prague one day's road off
